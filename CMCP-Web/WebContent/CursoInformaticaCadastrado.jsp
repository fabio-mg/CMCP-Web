...
<head>
	...
	<title>CMCP - Curso de Informatica Cadastrado com Sucesso!</title>
...
<body>
	<div class="container">
		<h2>CMCP - Curso de Informatica Cadastrado com Sucesso!</h2>
			...
			<div class="form-group">
				<label for="numLab">Número do Laboratório: ${cursoArtes.numLab}</label>  
			</div>
			
			<div class="form-group">
				<label for="softwares">Softwares: ${cursoArtes.softwares}</label>
			</div>
